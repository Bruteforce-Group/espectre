...
void CalibrationManager::set_expected_subcarriers(uint16_t num_sc) {
  ...
  // Use IEEE 802.11 standard guard bands for each mode
  // Reference: IEEE 802.11n (HT20/HT40) and 802.11ax (HE20)
  switch (num_sc) {
    case 64:   // HT20 (802.11n): 6 guard per side, DC at 32
      guard_band_low_ = 6;      // indices 0-5 are guard
      guard_band_high_ = 58;    // indices 59-63 are guard
      dc_subcarrier_ = 32;
      break;
